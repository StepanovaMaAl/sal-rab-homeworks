...
function calcInvoice({sum, discountMinSum, discountPart, shippingFreeMinSum, shippingPrice}) {
   ...
   let freeShipping// создайте переменную freeShipping
    ...
    freeShipping? shippingSum = 0: shippingSum > 0 // если shippingSum равно нулю, то freeShipping должна быть равна true, иначе freeShipping должна быть равна false
