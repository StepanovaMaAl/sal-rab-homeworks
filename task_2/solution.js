...
function calcInvoice({sum, discountMinSum, discountPart, shippingFreeMinSum, shippingPrice}) {
   ...
   totalSum = productsSum - discountSum // уменьшите totalSum на discountSum
    ...
    totalSum1 = totalSum + shippingSum// прибавьте к totalSum значение shippingSum

   let freeShipping// создайте переменную freeShipping
    // запишите без использования if или любых других условий:
    shippingSum? true: false // если shippingSum равно нулю, то freeShipping должна быть равна true, иначе freeShipping должна быть равна false
